...
class Place(object):
    ...
    def add_insect(self, insect):
        ...
        if insect.is_ant:
            if self.ant is None:
                ...
                # BEGIN Problem 9
                if self.ant.can_contain(insect):        #self.ant is BodyguardAnt
                    self.ant.contain_ant(insect)
                elif insect.can_contain(self.ant):      #insect passed is BodyguardAnt
    ...
    def remove_insect(self, insect):
        ...
        if insect.is_ant:
            ...
            # BEGIN Problem 13
            # "*** YOUR CODE HERE ***"
            if isinstance(insect, QueenAnt) and not insect.fakeQueen:
                return None
            # END Problem 13
...
# END Problem 13
    ...
    def __init__(self, armor = 1):
        ...
        self.fakeQueen = QueenAnt.fakeQueen 
        self.ants_have_been_doubled = []
        QueenAnt.fakeQueen = True
        # END Problem 13
