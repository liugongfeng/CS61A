...
def play(strategy0, strategy1, score0=0, score1=0, dice=six_sided,
    ...
    while True:
        ...
        score0 = score0 + take_turn(num_rolls_0, score1, dice)
        ...
        score1 = score1 + take_turn(num_rolls_1, score0, dice)
...
def announce_highest(who, previous_high=0, previous_score=0):
    ...
    def announce(score0, score1):
        ...
        if new_high > previous_high:
            if new_high==1:
                print("1 point! That's the biggest gain yet for", player)
                #return announce_highest(who, 1, new_high)
            else:
                print(new_high,"points! That's the biggest gain yet for", player)
