...
def make_withdraw(balance, password):
    ...
    "*** YOUR CODE HERE ***"
    IncorrectPassword = []
    def protected_withdraw(amount, inputedPassword):
        nonlocal balance
        if len(IncorrectPassword) == 3:
            return 'Your account is locked. Attempts: ' + str(IncorrectPassword)
        
        # wrong password:
        if inputedPassword != password:
            IncorrectPassword.append(inputedPassword)
...
def make_joint(withdraw, old_password, new_password):
    ...
    def joint(amount, inputedPassword):
        if inputedPassword == new_password:
            return withdraw(amount, old_password)
        return withdraw(amount, inputedPassword)
    return joint
...
They are designed to challenge you to think creatively!
"""
