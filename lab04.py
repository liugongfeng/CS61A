...
def distance(city1, city2):
    ...
    """
    "*** YOUR CODE HERE ***"
    position1 = city1[1:]   # [lat, lon]
    position2 = city2[1:]
    
    d = (position1[0] - position2[0])**2 + (position1[1] - position2[1])**2
    return sqrt(d)
...
def closer_city(lat, lon, city1, city2):
    ...
    "*** YOUR CODE HERE ***"
    Point = ['', lat, lon]
    distanceFromCity1 = distance(Point, city1)
    distanceFromCity2 = distance(Point, city2)
